...
QT       += core gui network multimedia multimediawidgets testlib printsupport widgets  quick quickwidgets qml  texttospeech charts svg  script
...
webassembly {
    # Copy font to output directory manually
    QMAKE_POST_LINK += ; cp $$PWD/fonts/appfont.ttf $$OUT_PWD/
}
